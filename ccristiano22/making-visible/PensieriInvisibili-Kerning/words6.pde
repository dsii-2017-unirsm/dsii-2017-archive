...
// Variabili Split per spaziatura
String[] parole1;
String[] parole2;
String[] parole3;
int index = 0;
...
void keyTyped() {
  ...
  // alternativa spazio tra le parole SP
  if (k == ' ' && SP == 2 & len < tbox.lim-2)  tbox.txt += "  ";
  if (k == ' ' && SP == 3 & len < tbox.lim-3)  tbox.txt += "    ";
  // alternativa Kerning SL (spazio lettere)
